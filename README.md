...
fiziği**, **Matematik**, **Jeopolitik**. Program ve modül iskeletleri `content/PLAN.md` içinde.
...
**Grafikler.** 98 etkileşimli SVG grafik elle yazılmış koddur. Hepsi gerçek bir
...
│  ├─ charts.js            SVG grafik motoru + 98 grafik
