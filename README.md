...
fiziği**, **Matematik**. Program ve modül iskeletleri `content/PLAN.md` içinde.
...
**Grafikler.** 94 etkileşimli SVG grafik elle yazılmış koddur. Hepsi gerçek bir
...
│  ├─ charts.js            SVG grafik motoru + 94 grafik
